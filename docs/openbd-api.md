...
1. **版元ドットコム会員社**（約520社）の書誌・書影
2. **国立国会図書館**のCC-BYライセンス書誌情報
3. **ホワイトリスト出版社**（利用許諾を得た出版社）のデータ

### JPROとの関係（重要）

2023年6月以前は、JPRO（出版情報登録センター）からのデータも含まれていたが、利用規約の問題により**2023年6月5日にJPROからのデータ配信が停止**された。

現在のopenBDは：

- 版元ドットコム会員社以外の書誌・書影の更新が制限されている
- 国立国会図書館のデータをベースとした代替APIを提供中
- 書影の収録範囲は以前より大幅に低下

参考: [HON.jp - JPROから版元ドットコムへの書誌・書影データ停止](https://hon.jp/news/1.0/0/43114)
